...
function initFileView() {
    vscode.window.registerTreeDataProvider('touchelf-file-view', exports.fileDataprovider);
    vscode.commands.registerCommand('touchelf.file.refresh', () => {
        exports.fileDataprovider.reload();
    });
    vscode.commands.registerCommand('touchelf.file.download', (entry) => __awaiter(this, void 0, void 0, function* () {
    ...
    vscode.commands.registerCommand('touchelf.file.upload', (entry) => {
    ...
    vscode.commands.registerCommand('touchelf.file.delete', (entry) => __awaiter(this, void 0, void 0, function* () {
        const api = new api_1.API(deviceView_1.currentDevice);
    ...
    vscode.commands.registerCommand('touchelf.file.preview', (entry) => __awaiter(this, void 0, void 0, function* () {
