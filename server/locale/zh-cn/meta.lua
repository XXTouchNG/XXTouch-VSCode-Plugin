...
string.encode_uri           = '将字符串转换为 URI 编码。'
string.decode_uri           = '将 URI 编码的字符串转换为原始字符串。'
string.encode_uri_component = '将字符串转换为 URI 组件编码。'
string.decode_uri_component = '将 URI 组件编码的字符串转换为原始字符串。'
