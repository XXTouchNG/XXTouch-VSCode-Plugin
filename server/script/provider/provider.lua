...
local function updateConfig()
    ...
    updated.completion.enable = updated.completion.enabled
    updated.hover.enable = updated.hover.enabled
    updated.signatureHelp.enable = updated.signatureHelp.enabled
    updated.diagnostics.enable = updated.diagnostics.enabled
